...
export default function Menu(){
    ...
    return(
        <div className="w-[1171px] h-[582px] bg-white rounded-xl ml-[20px] mb-[20px] p-5 flex flex-col">
        <p className="text-xl font-semibold">Pizzas</p>
        <div className="flex flex-wrap">{foods.map((food, index) => (
            <div key={food._id} className="mt-2 mb-4 p-3 w-[270.75px] h-[241px] bg-white border border-[#E4E4E7] rounded-xl flex flex-col">
