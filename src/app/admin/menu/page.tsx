...
export function Menu(){
    ...
    const searchParams = useSearchParams(); //? ymar hook we???
    const id = searchParams.get("id"); //end id-iig n haij olhiin tuld iim hook ashiglasan bh bishee GET method-oor buh idiig n unshuulhiin tuld
    console.log(id);
    ...
    const handleInput = (e: React.ChangeEvent<HTMLInputElement>)=>{
        const value = e.target.value //ene bol event dr orj irjiiga (what user typed) VALUE
        const field = e.target.name // minii tsaana n tohiruulj form state dr bichij ugsun neruud (name, price, ingredients...)
